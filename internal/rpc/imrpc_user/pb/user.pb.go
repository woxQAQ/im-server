...
var file_user_proto_goTypes = []interface{}{
	...
	(*ModifyInfoRequest)(nil), // 7: user.ModifyInfoRequest
	(*ModifyInfoResp)(nil),    // 8: user.ModifyInfoResp
}
var file_user_proto_depIdxs = []int32{
	...
	0, // 4: user.ModifyInfoRequest.gender:type_name -> user.Gender
	1, // 5: user.User.Login:input_type -> user.LoginRequest
	3, // 6: user.User.Register:input_type -> user.RegisterRequest
	5, // 7: user.User.UserInfo:input_type -> user.UserInfoRequest
	7, // 8: user.User.ModifyInfo:input_type -> user.ModifyInfoRequest
	2, // 9: user.User.Login:output_type -> user.LoginResp
	4, // 10: user.User.Register:output_type -> user.RegisterResp
	6, // 11: user.User.UserInfo:output_type -> user.UserInfoResp
	8, // 12: user.User.ModifyInfo:output_type -> user.ModifyInfoResp
